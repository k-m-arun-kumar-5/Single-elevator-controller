Description :
============
scalable 5 floor single elevator controller.
...
Note :
======
Kindly read in the source codes, if mentioned, about the Program Description or Purpose, Known Bugs, Caution & Notes and Documentation. Some applications are also tested in a LPC2138 development board.
