...
Bugs           :  
-*------------------------------------------------------------*/
uint8_t LED_Matrix_Init(const uint8_t led_matrix_ch_id, const uint8_t init_mode)
{
	 led_matrix_ctrl_t *cur_led_matrix_ctrl_ptr = NULL_PTR;
...
Bugs           :  
-*------------------------------------------------------------*/
uint8_t LED_Matrix_DeInit(const uint8_t led_matrix_ch_id, const uint8_t deinit_mode )
{
