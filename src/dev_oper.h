...
typedef struct
{
	...
	uint8_t            : 8 -  DEV_ID_BIT_SIZE; 
	uint8_t  dev_ch_id : DEV_CH_ID_BIT_SIZE;
	uint8_t            :  8 - (DEV_CH_ID_BIT_SIZE); 
} dev_id_t;
 ...
 typedef enum
{
  ...
  COMM_DEV_ID_SPI, COMM_DEV_ID_MISC, INPUT_DEV_ID_KEYBOARD, INPUT_DEV_ID_ADC, INPUT_DEV_ID_SW, NUM_DEVS, DEV_ID_INVALID 	
} dev_src_id_t;
...
typedef uint8_t (*dev_deinit_t)(const uint8_t dev_ch_id, const uint8_t deinit_mode);
typedef uint8_t (*dev_init_t)(const uint8_t dev_ch_id, const uint8_t init_mode);
...
typedef uint8_t (*comm_dev_receive)(const uint8_t dev_ch_id, const uint8_t enable_ctrl);
typedef uint8_t (*comm_dev_transmit)(const uint8_t dev_ch_id, const uint8_t enable_ctrl);
