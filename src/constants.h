...
#define EXPIRY_SERVICE_INTERRUPT       (0)
#define EXPIRY_SERVICE_POLLING         (1)
#define EXPIRY_SERVICE_INVALID         (2)
...
typedef enum
{
	STREAM_BUFFER_INVALID, STREAM_BUFFER_INPUT, STREAM_BUFFER_OUTPUT
} stream_buffer_type_t;

typedef struct
{
	char stream_buffer[STREAM_BUFFER_LEN];
    uint8_t num_chars_stream_buffer;
    uint8_t  stream_buffer_type          : 2;
    uint8_t                              : 6;   	
} stream_t;
