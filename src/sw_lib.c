...
BUGS           :              
-*------------------------------------------------------------*/
uint8_t SW_Read_By_IO_Ch(const uint8_t io_ch, uint8_t *const read_data_ptr )
{
	 uint8_t ret_status = SUCCESS, sw_ch_id;
	  
	 if(read_data_ptr == NULL_PTR)
	 {
		 system_status_flag = ERR_NULL_PTR;
...
uint8_t SW_Press_Proc(const uint8_t sw_ch_id, void *const dummy_ptr)
{
	...
	uint8_t ret_status = SW_OR_KEY_NOT_PRESSED, sw_read_data;
...
{
	sw_para_t *sw_para_ptr;
	uint8_t ret_status, sw_read_data;
...
BUGS           :              
-*------------------------------------------------------------*/
uint8_t SW_Read(const uint8_t sw_ch_id, uint8_t *const sw_read_data_ptr)
{
	uint8_t ret_status = SUCCESS;
	sw_para_t *cur_sw_para_ptr = NULL_PTR;
	
	if(sw_read_data_ptr == NULL_PTR)
	{
		 system_status_flag = ERR_NULL_PTR;
...
Bugs           :  
-*------------------------------------------------------------*/
uint8_t SW_Init(const uint8_t sw_ch_id, const uint8_t init_mode)
{
	 sw_para_t *cur_sw_para_ptr = NULL_PTR;
...
Bugs           :  
-*------------------------------------------------------------*/
uint8_t SW_DeInit(const uint8_t sw_ch_id, const uint8_t deinit_mode)
{
	 sw_para_t *cur_sw_para_ptr = NULL_PTR;
...
{
	typedef uint8_t (*sw_init_oper_t)(const uint8_t sw_ch_id, const uint8_t oper_type);
    typedef uint8_t (*sw_non_init_and_read_oper_t)(const uint8_t sw_ch_id);
